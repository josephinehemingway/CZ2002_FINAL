...
/**
 * Control class which performs the sending of notifications to the student's email.
...
class SendMailSSLCtrl {
  ...
  /**
   * Sends message notifying the student that he/she has successfully registered for a course.
   * 
   * @param courseName The courseName of the course the the student has successfully registered for.
   * @param courseID The courseID of the course the student has successfully registered for.
   * @param IndexID The indexID of the course the student has successfully registered for.
  ...
  /**
   * Sends message notifying the student that he/she has been placed on the waitingList for the course he/she wants to register
   * @param courseName The courseID of the course the student has been placed on waitinglist for.
   * @param IndexID The indexID of the course the student has been placed on waitinglist for.
  ...
  /**
   * Sends message notifying the student that he/she has successfully swapped index with his/her peer.
   * @param courseID The courseId of the course the student wants to swap indexes for.
   ...
   * @param peerName The name of the peer the student is swapping indexes with.
  ...
  /**
   * Sends message notifying the the student that he/she has successfully dropped the Course.
